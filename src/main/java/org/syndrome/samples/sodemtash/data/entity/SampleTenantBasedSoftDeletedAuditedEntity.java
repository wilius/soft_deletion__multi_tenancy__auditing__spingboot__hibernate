...
@Entity
@Table(name = "sample_tenant_based_soft_deleted_audited_entity")
@SequenceGenerator(
        name = BaseEntity.DEFAULT_ID_GENERATOR_NAME,
        sequenceName = "sample_tenant_based_soft_deleted_audited_entity_seq",
        allocationSize = 1)
public class SampleTenantBasedSoftDeletedAuditedEntity extends TenantBasedSoftDeletedAuditedEntity {
}
